...
public interface BookingService {
    ...
    public List<BookingDTOResponse> getBookingByCurrentUser(Long userId, String state);

    public List<BookingDTOResponse> getBookingByOwnerItems(Long userId, String state);
